...
python ../scripts/wellington_bootstrap.py $@
...
python ../scripts/dnase_wig_tracks.py $3 $1 treatment1_output_visualisation/fw_cuts.wig treatment1_output_visualisation/rv_cuts.wig
...
#get the wiggle tracks
python ../scripts/dnase_wig_tracks.py $3 $2 treatment2_output_visualisation/fw_cuts.wig treatment2_output_visualisation/rv_cuts.wig
