...
cut -f -3 $1 > temp1.bed
../bedtools/bin/bedops --range 50 --everything temp.bed > temp1_2.bed
...
if [ $1 != '--start' ]
	then
		cut -f -3 $1 > temp2.bed
		../bedtools/bin/bedops --range 50 --everything temp.bed > temp2_2.bed
		../bedtools/bin/bedops --merge processed_peaks.bed temp2_2.bed > processed_peaks.bed
		rm temp2.bed
		rm temp2_2.bed
