...
class CsiEm(object):
    ...
    def setup(self, pset, poolsize=None):
        ...
        self.pset = pset
        #TWEAK - this used to be sp.randn, leading to N(0,1)
        #changed to sp.rand, leading to U(0,1), to match Chris code
        self.hypers = sp.exp(sp.rand(3))
        #TWEAK - alter the order of the hyperparameters to match Matlab random generation
        holder = self.hypers[0]
        self.hypers[0] = self.hypers[1]
        self.hypers[1] = holder
        self.weights = w
        self.tol = 0.1
    ...
    def setup_nohypers(self, pset, poolsize=None):
        '''Configure model for EM using the specified parent set.
        Tweaked to not initialise hyperparameters, to match Matlab randomness.'''
        ...
        self.pset = pset
        #no hyperparameter initialisation, it's done from outside
        self.weights = w
        self.tol = 0.1
